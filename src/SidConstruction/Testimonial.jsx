...
const Testimonial = ()=>{
    const card = (testimonial)=>{
        return(<div className="text-blue-900 text-justify w-[300px] h-[250px] border-amber-500 border-2 rounded flex flex-col space-y-5 mt-5 p-4">
            <FormatQuoteIcon fontSize="large" className=" text-amber-500 font-bold"/>
            <p>{testimonial.comment}</p>
            <div className="credits flex gap-5 ">
                <img src={testimonial.pic} className="w-[50px] h-[50px] rounded-full"/>
                <div className="flex flex-col  text-left">
                    <span className="text-amber-500 text-xl font-bold">{testimonial.name}</span>
    ...
    return(<section className="mx-30 text-center space-y-5 mb-10">
